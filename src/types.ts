 ...
 *
 * Constraint `AASd-116`:
 * `globalAssetId` is a reserved key for {@link SpecificAssetId.name} with the
 * semantics as defined in {@link AssetInformation.globalAssetId}.
 *
 * **Note**:
...
export class AssetInformation extends Class {
  ...
  /**
   * Denotes whether the Asset is of kind {@link AssetKind.Type},
   * {@link AssetKind.Instance}, {@link AssetKind.Role}, or
   * {@link AssetKind.NotApplicable}.
   */
  assetKind: AssetKind;
  ...
  /**
   * In case {@link assetKind} is {@link AssetKind.NotApplicable} the
   * {@link assetType} is the asset ID of the type asset of the asset under
   * consideration as identified by {@link globalAssetId}.
   *
   * @remarks
   * **Note**:
   * In case {@link assetKind} is "Instance" then the {@link assetType} denotes
...
export function* overAssetKind(): IterableIterator<AssetKind> {
  ...
  yield <AssetKind>2; // Role
  yield <AssetKind>3; // NotApplicable
}
...
export interface IRelationshipElement extends ISubmodelElement {
   ...
   */
  first: Reference | null;

  /**
   * Reference to the second element in the relationship taking the role of the object.
   */
  second: Reference | null;
}
...
export class RelationshipElement extends Class implements IRelationshipElement {
  ...
  *descend(): IterableIterator<Class> {
  ...
  constructor(
    ...
    qualifiers: Array<Qualifier> | null = null,
    embeddedDataSpecifications: Array<EmbeddedDataSpecification> | null = null,
    first: Reference | null = null,
    second: Reference | null = null
  ) {
    super();
    this.extensions = extensions;
    this.idShort = idShort;
 ...
 * of an {@link Entity} must be set if Entity/entityType is set to {@link EntityType.SelfManagedEntity}.
 */
...
export class ValueReferencePair extends Class {
  ...
  *descend(): IterableIterator<Class> {
  ...
  constructor(value: string, valueId: Reference | null = null) {
    super();
    this.value = value;
    this.valueId = valueId;
  }
