...
test("ModellingKind deserializes Template OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.ModellingKind.Template);
});
...
test("ModellingKind deserializes Instance OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.ModellingKind.Instance);
});
...
test("QualifierKind deserializes ValueQualifier OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.QualifierKind.ValueQualifier);
});
...
test("QualifierKind deserializes ConceptQualifier OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.QualifierKind.ConceptQualifier);
});
...
test("QualifierKind deserializes TemplateQualifier OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.QualifierKind.TemplateQualifier);
});
...
test("AssetKind deserializes Type OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AssetKind.Type);
});
...
test("AssetKind deserializes Instance OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AssetKind.Instance);
});

test("AssetKind deserializes Role OK", () => {
  const jsonable = "Role";
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AssetKind.Role);
});
...
test("AssetKind deserializes NotApplicable OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AssetKind.NotApplicable);
});
...
test("AasSubmodelElements deserializes BasicEventElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.BasicEventElement);
});
...
test("AasSubmodelElements deserializes Blob OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.Blob);
});
...
test("AasSubmodelElements deserializes Capability OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.Capability);
});
...
test("AasSubmodelElements deserializes DataElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.DataElement);
});
...
test("AasSubmodelElements deserializes Entity OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.Entity);
});
...
test("AasSubmodelElements deserializes EventElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.EventElement);
});
...
test("AasSubmodelElements deserializes File OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.File);
});
...
test("AasSubmodelElements deserializes Operation OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.Operation);
});
...
test("AasSubmodelElements deserializes Property OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.Property);
});
...
test("AasSubmodelElements deserializes Range OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.Range);
});
...
test("AasSubmodelElements deserializes ReferenceElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.ReferenceElement);
});
...
test("AasSubmodelElements deserializes RelationshipElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.RelationshipElement);
});
...
test("AasSubmodelElements deserializes SubmodelElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.SubmodelElement);
});
...
test("AasSubmodelElements deserializes SubmodelElementList OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.AasSubmodelElements.SubmodelElementList);
});
...
test("EntityType deserializes CoManagedEntity OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.EntityType.CoManagedEntity);
});
...
test("EntityType deserializes SelfManagedEntity OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.EntityType.SelfManagedEntity);
});
...
test("Direction deserializes Input OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.Direction.Input);
});
...
test("Direction deserializes Output OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.Direction.Output);
});
...
test("StateOfEvent deserializes On OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.StateOfEvent.On);
});
...
test("StateOfEvent deserializes Off OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.StateOfEvent.Off);
});
...
test("ReferenceTypes deserializes ExternalReference OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.ReferenceTypes.ExternalReference);
});
...
test("ReferenceTypes deserializes ModelReference OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.ReferenceTypes.ModelReference);
});
...
test("KeyTypes deserializes AnnotatedRelationshipElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.AnnotatedRelationshipElement);
});
...
test("KeyTypes deserializes AssetAdministrationShell OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.AssetAdministrationShell);
});
...
test("KeyTypes deserializes BasicEventElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.BasicEventElement);
});
...
test("KeyTypes deserializes Blob OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.Blob);
});
...
test("KeyTypes deserializes Capability OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.Capability);
});
...
test("KeyTypes deserializes ConceptDescription OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.ConceptDescription);
});
...
test("KeyTypes deserializes DataElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.DataElement);
});
...
test("KeyTypes deserializes Entity OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.Entity);
});
...
test("KeyTypes deserializes EventElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.EventElement);
});
...
test("KeyTypes deserializes File OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.File);
});
...
test("KeyTypes deserializes FragmentReference OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.FragmentReference);
});
...
test("KeyTypes deserializes GlobalReference OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.GlobalReference);
});
...
test("KeyTypes deserializes Identifiable OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.Identifiable);
});
...
test("KeyTypes deserializes MultiLanguageProperty OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.MultiLanguageProperty);
});
...
test("KeyTypes deserializes Operation OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.Operation);
});
...
test("KeyTypes deserializes Property OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.Property);
});
...
test("KeyTypes deserializes Range OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.Range);
});
...
test("KeyTypes deserializes Referable OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.Referable);
});
...
test("KeyTypes deserializes ReferenceElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.ReferenceElement);
});
...
test("KeyTypes deserializes RelationshipElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.RelationshipElement);
});
...
test("KeyTypes deserializes Submodel OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.Submodel);
});
...
test("KeyTypes deserializes SubmodelElement OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.SubmodelElement);
});
...
test("KeyTypes deserializes SubmodelElementCollection OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.SubmodelElementCollection);
});
...
test("KeyTypes deserializes SubmodelElementList OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.KeyTypes.SubmodelElementList);
});
...
test("DataTypeDefXsd deserializes AnyUri OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.AnyUri);
});
...
test("DataTypeDefXsd deserializes Base64Binary OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Base64Binary);
});
...
test("DataTypeDefXsd deserializes Boolean OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Boolean);
});
...
test("DataTypeDefXsd deserializes Byte OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Byte);
});
...
test("DataTypeDefXsd deserializes Date OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Date);
});
...
test("DataTypeDefXsd deserializes DateTime OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.DateTime);
});
...
test("DataTypeDefXsd deserializes Decimal OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Decimal);
});
...
test("DataTypeDefXsd deserializes Double OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Double);
});
...
test("DataTypeDefXsd deserializes Duration OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Duration);
});
...
test("DataTypeDefXsd deserializes Float OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Float);
});
...
test("DataTypeDefXsd deserializes GDay OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.GDay);
});
...
test("DataTypeDefXsd deserializes GMonth OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.GMonth);
});
...
test("DataTypeDefXsd deserializes GMonthDay OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.GMonthDay);
});
...
test("DataTypeDefXsd deserializes GYear OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.GYear);
});
...
test("DataTypeDefXsd deserializes GYearMonth OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.GYearMonth);
});
...
test("DataTypeDefXsd deserializes HexBinary OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.HexBinary);
});
...
test("DataTypeDefXsd deserializes Int OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Int);
});
...
test("DataTypeDefXsd deserializes Integer OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Integer);
});
...
test("DataTypeDefXsd deserializes Long OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Long);
});
...
test("DataTypeDefXsd deserializes NegativeInteger OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.NegativeInteger);
});
...
test("DataTypeDefXsd deserializes NonNegativeInteger OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.NonNegativeInteger);
});
...
test("DataTypeDefXsd deserializes NonPositiveInteger OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.NonPositiveInteger);
});
...
test("DataTypeDefXsd deserializes PositiveInteger OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.PositiveInteger);
});
...
test("DataTypeDefXsd deserializes Short OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Short);
});
...
test("DataTypeDefXsd deserializes String OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.String);
});
...
test("DataTypeDefXsd deserializes Time OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.Time);
});
...
test("DataTypeDefXsd deserializes UnsignedByte OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.UnsignedByte);
});
...
test("DataTypeDefXsd deserializes UnsignedInt OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.UnsignedInt);
});
...
test("DataTypeDefXsd deserializes UnsignedLong OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.UnsignedLong);
});
...
test("DataTypeDefXsd deserializes UnsignedShort OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeDefXsd.UnsignedShort);
});
...
test("DataTypeIec61360 deserializes Date OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.Date);
});
...
test("DataTypeIec61360 deserializes String OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.String);
});
...
test("DataTypeIec61360 deserializes StringTranslatable OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.StringTranslatable);
});
...
test("DataTypeIec61360 deserializes IntegerMeasure OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.IntegerMeasure);
});
...
test("DataTypeIec61360 deserializes IntegerCount OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.IntegerCount);
});
...
test("DataTypeIec61360 deserializes IntegerCurrency OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.IntegerCurrency);
});
...
test("DataTypeIec61360 deserializes RealMeasure OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.RealMeasure);
});
...
test("DataTypeIec61360 deserializes RealCount OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.RealCount);
});
...
test("DataTypeIec61360 deserializes RealCurrency OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.RealCurrency);
});
...
test("DataTypeIec61360 deserializes Boolean OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.Boolean);
});
...
test("DataTypeIec61360 deserializes Iri OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.Iri);
});
...
test("DataTypeIec61360 deserializes Irdi OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.Irdi);
});
...
test("DataTypeIec61360 deserializes Rational OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.Rational);
});
...
test("DataTypeIec61360 deserializes RationalMeasure OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.RationalMeasure);
});
...
test("DataTypeIec61360 deserializes Time OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.Time);
});
...
test("DataTypeIec61360 deserializes Timestamp OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.Timestamp);
});
...
test("DataTypeIec61360 deserializes File OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.File);
});
...
test("DataTypeIec61360 deserializes Html OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.Html);
});
...
test("DataTypeIec61360 deserializes Blob OK", () => {
  ...
  expect(parsedLiteral).toStrictEqual(AasTypes.DataTypeIec61360.Blob);
});
